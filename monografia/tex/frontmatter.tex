...
\begin{simbolos}
  ...
  \item[$z^*$] Conjugado do número complexo $z$
  
  \item[$\mathbb{\wedge}$] função boleana $\mathrm{AND}$
  ...
  \item[$A^T$] Matriz transposta da matriz $A$
  \item[$A^\dagger$] Matriz conjugada da matriz $A^T$
